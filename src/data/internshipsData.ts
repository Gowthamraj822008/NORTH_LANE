...
export const INITIAL_ORGANIZATIONS: Organization[] = [
  ...
  },
  {
    ...
    website: 'https://cloudscale-demo.io',
    size: '80 employees',
    ...
    contactEmail: 'founder@cloudscale-demo.io',
...
export const INITIAL_APPLICATIONS: InternshipApplication[] = [
  {
    ...
    studentEmail: 'gowtham.r@sairam.edu.in',
    ...
    resumeFileName: 'Gowtham_R_Data_Engineer_Resume.pdf',
    interviewDetails: {
      date: '2026-09-22',
      time: '14:30 IST',
